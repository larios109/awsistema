...
class detalleventaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('M_ventas.detalleventas.index')->with('detalleventas', json_decode($response,true));
    }
    ...
    public function create()
    {
        ...
        return view('M_ventas.detalleventas.create')
    ...
    public function edit($cod_detalle_venta)
    {
        ...
        return view ('M_ventas.detalleventas.edit',['detalleventa'=>$detalleventa])
