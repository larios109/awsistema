        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Cantidad Materia Requerida</label>
                 <div class="col-sm-7">
                    <input type="number" id="Cantidad" name="Cantidad" min="1" max="99999999" maxlength="8" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ingrese la cantidad" value="{{old('Cantidad')}}">
                </div>
