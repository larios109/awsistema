        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Nombre Materia</label>
                 <div class="col-sm-7">
                    <input type="text" id="Nombre" name="Nombre" class="form-control" maxlength="25" onkeydown="return /[a-z, ]/i.test(event.key)" onkeyup="capitalizarPrimeraLetranombre()" placeholder="Ingrese el nombre" value="{{$materiaprima->nom_materia}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Descripcion</label>
                 <div class="col-sm-7">
                    <input type="text" id="Descripcion" name="Descripcion" class="form-control" maxlength="30" onkeyup="capitalizarPrimeraLetradescripcion()" placeholder="Ingrese la descripcion" value="{{$materiaprima->descripcion}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Precio Compra Materia</label>
                 <div class="col-sm-7">
                    <input type="number" id="Precio" name="Precio" min="1" max="99999999" maxlength="8" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" placeholder="Ingrese el Precio" value="{{$materiaprima->pre_Compra_materia}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Tipo de Medida</label>
                 <div class="col-sm-7">
                    <input type="text" id="Medida" name="Medida"  class="form-control" maxlength="20" onkeydown="return /[a-z, ]/i.test(event.key)" onkeyup="capitalizarPrimeraLetramedida()" placeholder="Ingrese la medida" value="{{$materiaprima->tip_medida}}">
                </div>
