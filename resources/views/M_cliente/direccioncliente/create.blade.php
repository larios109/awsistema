        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Ciudad</label>
                 <div class="col-sm-7">
                    <input type="text" id="Ciudad" name="Ciudad" class="form-control" maxlength="20" onkeydown="return /[a-z, ]/i.test(event.key)" onkeyup="capitalizarPrimeraLetraciudad()" placeholder="Ingrese la direccion de la ciudad" value="{{old('Ciudad')}}">
                </div>
