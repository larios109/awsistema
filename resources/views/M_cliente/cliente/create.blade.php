        ...
        <div class="row mb-3">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Nombre Compañia</label>
                 <div class="col-sm-7">
                    <input type="text" id="Compania" name="Compania" class="form-control" maxlength="20" onkeydown="return /[a-z, ]/i.test(event.key)" onkeyup="capitalizarPrimeraLetracompania()" placeholder="Ingrese la compañia" value="{{old('Compania')}}">
                </div>
